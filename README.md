# Angular Academy Demo Universal

Demo Project for the Universal part of an <a href="https://angular.ac" target="_blank">Angular Academy</a> workshop.
...
Run `npm run dev:ssr` for a local dev Universal server.
